    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center min-h-screen">
                <div className="flex flex-col md:flex-row items-center bg-white rounded-lg max-w-4xl p-5 backdrop-blur-lg shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] relative overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2 p-5">
                        <div className="text-center mb-5">
                            <h3 className="text-[#D97C2B] lg:text-3xl text-2xl font-extrabold max-md:text-center">Inscription</h3>
                        </div>

                        <div className="mb-4">
                            <p className="text-gray-600 mt-1">Créer un compte administrateur</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="text-left my-2">
                                <label className="text-gray-800 text-sm font-medium mb-2" htmlFor="telephone">Téléphone</label>
                                <div className="relative flex items-center">
                                    <input name="telephone" id="telephone" type="tel" value={telephone} onChange={onTelephoneChange} required className="w-full bg-transparent mt-1 block p-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#E85213] focus:border-[#E85213]" placeholder="Entrer votre téléphone" />
                                    <svg
                                        viewBox="0 0 512 512"
                                        fill="#000" stroke="#000"
                                        height="20"
                            ...
                            >
                                {load ? "Chargement..." : "Créer"}
                            </button>
                        </form>
                    </div>

                    <div className="absolute -top-6 -right-6 w-20 h-20 rounded-full bg-[#E85213] max-sm:hidden"></div>
                </div>
            </div>
        </>
    );
